...
var backgroundmusic, watersplashsound, piratelaughsound, canonsound
var isLaughing = false

function preload() {
  backgroundmusic= loadSound('./assets/assets_background_music.mp3')
  watersplashsound= loadSound('./assets/assets_cannon_water.mp3')
  canonsound= loadSound('./assets/assets_cannon_explosion.mp3')
...
swal({
  title:'GAMEOVER', 
  text:'refresh tab to play again',
